...
----------------------------------------------------------------------------------------------------
Sparsi (Multi-Step DAG)        100.00%      1.74            377.82           65936            0         
LangChain (ReAct Agent)        94.00%      2.92            523.96           259039           0         
==========================================
```
...
1. **Tokens (Cost)**: Sparsi is definitively cheaper, consuming less than 1/4th of LangChain's tokens (~66k vs ~259k). ReAct agents are inherently token-hungry because they must embed massive system rules, tool schemas, and their own expanding reasoning history into every single iterative loop.
